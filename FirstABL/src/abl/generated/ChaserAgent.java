...
public class ChaserAgent extends BehavingEntity {
   ...
   private static void registerBehaviors_0(BehaviorLibrary behaviorLibrary) {
      ...
      behaviorLibrary.registerBehavior(new __BehaviorDesc(1, __$behaviorFactory0_rfield, __$precondition0_rfield, __$preconditionSensorFactory0_rfield, "fire()", new String[] {"fire()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(2, __$behaviorFactory0_rfield, null, null, "WaitAndChangeColor()", new String[] {"WaitAndChangeColor()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(3, __$behaviorFactory0_rfield, null, null, "manageMovement()", new String[] {"manageMovement()"}, null, (short)0));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(4, __$behaviorFactory0_rfield, __$precondition0_rfield, __$preconditionSensorFactory0_rfield, "move()", new String[] {"move()"}, null, (short)3));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(5, __$behaviorFactory0_rfield, __$precondition0_rfield, __$preconditionSensorFactory0_rfield, "move()", new String[] {"move()"}, null, (short)3));
      behaviorLibrary.registerBehavior(new __BehaviorDesc(6, __$behaviorFactory0_rfield, __$precondition0_rfield, __$preconditionSensorFactory0_rfield, "move()", new String[] {"move()"}, null, (short)2));
      ...
      behaviorLibrary.registerBehavior(new __BehaviorDesc(8, __$behaviorFactory0_rfield, null, null, "move()", new String[] {"move()"}, null, (short)1));
      ...
      behaviorLibrary.registerBehavior(new __BehaviorDesc(10, __$behaviorFactory0_rfield, null, null, "ChaserAgent_RootCollectionBehavior()", new String[] {"ChaserAgent_RootCollectionBehavior()"}, null, (short)0));
   }
   ...
   public ChaserAgent() {
      ...
      ABT = (CollectionBehavior)ChaserAgent_BehaviorFactories.behaviorFactory0(10, null, null, null, "ChaserAgent_RootCollectionBehavior()");
